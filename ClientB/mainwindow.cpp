...
void MainWindow::slotNewConnection()
{
    ...
    sendPackage(clientC,"CConnected");
    clientC->flush();
}
...
//        qDebug() << "mesg_len:" << mesg_len;
        ...
        else if(str.startsWith("LandLord "))
        {
            ...
            ui->labelBStatus->setText("玩家C:农民");
            ui->labelCStatus->setText("玩家A:农民");
            if(alp == "A")
            {
                //A当选地主
                status = RoundC;
                ...
                //设置身份
                ui->labelCStatus->setText("玩家A:地主");
            }
            else if(alp == "B")
            {
                //B自己当选
            ...
            else
            {
                ...
                //设置身份
                ui->labelBStatus->setText("玩家C:地主");
            }
            //再次初始化label
            ui->labelAIsRun->setText("");
            ui->labelBIsRun->setText("");
        ...
        else if(str.startsWith("Restart"))
        {
            ...
            ui->labelBStatus->setText("玩家C:未知");
            ui->labelCStatus->setText("玩家A:未知");
            status = Choosing;
            update();
        }
...
void MainWindow::on_pushButtonStart_clicked()
{
    ...
    //连接服务器
    clientC->connectToHost(QHostAddress("127.0.0.1"), 18001);
    //通过信号接收服务器数据
    ...
    //将套接字设置为监听模式
    serverB->listen(QHostAddress::Any, 18003);
    //通过信号接收客户端请求
...
{
    sendPackage(clientC,"Continued");
    clientC->flush();
}

void MainWindow::on_pushButtonQuit_clicked()
{
//    sendPackage(clientC,"NotContinued");
//    clientC->flush();
    close();
}
